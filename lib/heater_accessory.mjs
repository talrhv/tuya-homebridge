...
class HeaterAccessory extends BaseAccessory {
  ...
  refreshAccessoryServiceIfNeed(statusArr, isRefresh) {
    ...
    for (var statusMap of statusArr) {
      ...
      if (
        statusMap.code === "temp_current" ||
        statusMap.code === "temp_current_f"
      ) {
        this.temperatureMap = statusMap;
        this.normalAsync(
          Characteristic.CurrentTemperature,
          this.temperatureMap.value,
          {
            minValue: -20,
            maxValue: 122,
            minStep: 1,
        ...
        const hbUnits = this.tuyaParamToHomeBridge(
      ...
      if (statusMap.code === "level") {
        ...
        const hbSpeed = this.tuyaParamToHomeBridge(
      ...
      if (statusMap.code === "shake") {
        ...
        const hbShake = this.tuyaParamToHomeBridge(
  ...
  getAccessoryCharacteristic(name, props) {
    ...
    this.service
      ...
      .on("set", (value, callback) => {
        if (
          name == Characteristic.TargetHeaterCoolerState ||
