...
class ValveAccessory extends BaseAccessory {
  ...
  initStatus() {
    ...
    service.getCharacteristic(Characteristic.RemainingDuration).onGet(() => {
    ...
    service
      ...
      .onSet(async (value) => {
        ...
        try {
          // שולחים לטויה רק אם הברז דולק כרגע
  ...
  async setSwitch(value) {
    ...
    // שימוש בזמן שנבחר בסליידר (SetDuration) כשמפעילים את הברז
